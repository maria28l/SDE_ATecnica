<%@ Page Title="" Language="C#" MasterPageFile="~/app/Site.master" AutoEventWireup="true" CodeFile="ClientesARegionales.aspx.cs" EnableEventValidation="false" Inherits="transacciones_ClientesARegionales" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" Runat="Server">
    <script src="../Scripts/procesos/clientes_regionales.js" type="text/javascript"></script>
</asp:Content>
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-body table-responsive">
                        <asp:Button ID="btnActualizar_cr" runat="server" Text="..." CssClass="btn btn-primary" onclick="btnActualizar_cr_Click" Visible="False"/>
                        <asp:GridView ID="gvClientesARegionales" runat="server" CssClass="table table-bordered table-hover" AlternatingRowStyle-BackColor= "Beige" AutoGenerateColumns="false">
                            <Columns>
                               <asp:TemplateField>
                                    <ItemTemplate>                                          
                                        <a href="javascript:void(0)" onclick="AgregarAsignacionARegionales('<%# Eval("Cargo_Regional") %>','<%# Eval("Cod_Personal_Asigna") %>','<%# Eval("Cod_Cliente") %>','<%# Eval("Cod_Sucursal") %>','<%# Eval("Cod_Facilitador") %>')"><img alt="Mostrar Eventos" src="/assets/img/icons/show.png" /></a>                                        
                                    </ItemTemplate>
                                </asp:TemplateField>    
...
<div class="modal fade" id="dlgFormClientesARegionales" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title">Asignar a Regional</h4>
            </div>
                ...
                <div class="system-form2">
                    <div class="form-horizontal">
                        ...
                        <div id="cCodFacilitador" class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label class="col-lg-4 control-label">*Regional</label>
                                    <div class="col-lg-8">
