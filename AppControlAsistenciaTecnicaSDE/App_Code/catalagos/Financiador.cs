...
{
    /// <summary>
    /// Summary description for Financiador
    /// </summary>
    public class Financiador : ICloneable
    {
        ...
        public Financiador(string Des_Financiador)
        {
            mDes_Financiador = Des_Financiador;
        }
        public Financiador(string Cod_Empresa, string Cod_Financiador, string Des_Financiador, int Cod_Registro, string Tip_EstadoReg, string Cod_Usuario_Creo, DateTime Fec_Creado, string Cod_Usuario_Modifico, DateTime Fec_Modificado, string Cad_Equipo)
        {
        ...
        public static DataTable Obtener_TablaFinanciadoresParaDdl()
        {
            DataTable dt;
            try
            {
                SqlCommand cmd = new SqlCommand { CommandText = "dbo.usp_ObtenerFinanciadorParaDdl", CommandType = CommandType.StoredProcedure };
